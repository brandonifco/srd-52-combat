...
public class SeededInitiativeReplayTests
{
    ...
    /// until green.
    /// </summary>
    private const string RecordedReplaySha256 = "20fb2e9bf238ec35aa6483690b4acb29b75a4b94bb04e754417a2325f0bc88f9";
    ...
    public void A_seeded_Initiative_replays_byte_for_byte_from_its_seed_and_its_recorded_tie_breaks()
    {
        ...
        // Comparable only under the same identity: ruleset srd-5.2.1-combat v4, PCG32, map 2.0.0.
        Assert.Equal("srd-5.2.1-combat", Ruleset.Identity.Ruleset.Id);
        Assert.Equal(4, Ruleset.Identity.Ruleset.Version);
        Assert.Equal(RulesKernel.Identity.RandomAlgorithmId.Pcg32SetSeq64XshRr32, Ruleset.Identity.RandomAlgorithm);
        Assert.StartsWith(
            "identity srd-5.2.1-combat v4 schema 1 map RulesFactory.Maps.Srd52Combat 2.0.0\n",
