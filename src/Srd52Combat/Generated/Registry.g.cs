...
public static class Registry
{
    ...
    [
        ...
        new("attack-sources", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttackSources.Locator]),
        new("attack-structure", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttackStructure.Locator]),
        new("attack-target", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttackTarget.Locator]),
        new("attack-modifiers", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttackModifiers.Locator]),
        new("attack-resolution", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.AttackResolution.Locator]),
        new("flanking", EntryStatus.Declined, CorrespondenceRow.ScopeOut, [MapEntries.Flanking.Locator]),
        new("unseen-target-disadvantage", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.UnseenTargetDisadvantage.Locator]),
        new("wrong-location-misses", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.WrongLocationMisses.Locator]),
        new("unseen-attacker-advantage", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.UnseenAttackerAdvantage.Locator]),
        new("hidden-attacker-revealed", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.HiddenAttackerRevealed.Locator]),
        ...
        new("normal-and-long-range", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.NormalAndLongRange.Locator]),
        new("ranged-in-close-combat", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.RangedInCloseCombat.Locator]),
        ...
        new("opportunity-attack", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.OpportunityAttack.Locator]),
        new("opportunity-attack-avoidance", EntryStatus.Mapped, CorrespondenceRow.NotBuilt, [MapEntries.OpportunityAttackAvoidance.Locator]),
